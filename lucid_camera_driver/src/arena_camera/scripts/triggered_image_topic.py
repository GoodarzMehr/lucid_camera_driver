...
class TriggeredImageTopic():
    """
    This node enables the transformation of a trigger topic to an image topic
    using GrabImageAction. Whenever a signal is published on ~trigger a
    sensor_msg.msg.Image is published on the output topic.
    ...
    def __init__(self):
        ...
        self.pub = rospy.Publisher(self.output_topic_name, Image,
                                   queue_size = 10)
